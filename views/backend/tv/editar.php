  ...
  <?php $this->load->view('backend/layout/sidebar'); ?>
	<div class="container-fluid" id="pcont">    
      ...
      <ol class="breadcrumb">
          ...
          <li><a href="backend/Tv/index">Tv</a></li>
            ...
            <div class="content">
              ...
              ?>   
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-6">
                      <input name="tiempo" id="tiempo" type="text" class="form-control" placeholder="" value="<?php echo $datos->tiempo;?>"></div>
                </div>
                <div class="form-group">
                      <label class="col-sm-3 control-label">Slogan</label>
                      <div class="col-sm-6">
                      <input name="slogan" id="slogan" type="text" class="form-control" placeholder="" value="<?php echo $datos->slogan;?>"></div>
                </div>
                <div class="form-group">
