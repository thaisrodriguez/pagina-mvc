            ...
            <div class="content">
              ...
              ?>        
                <div class="form-group">
                      ...
                      <div class="col-sm-6">
                      <input name="titulo" id="titulo" type="text" class="form-control" placeholder="" value="<?php echo $datos->titulo;?>">
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-6">
                      <input name="seo" id="seo" type="text" class="form-control" placeholder="" value="<?php echo $datos->seo;?>"></div>
                </div>
                <div class="form-group">
                      <label class="col-sm-3 control-label">Posición imagen</label>
                      <div class="col-sm-6">
                      <input name="posicion" id="posicion" type="text" class="form-control" placeholder="" value="<?php echo $datos->posicion;?>"></div>
                </div>   
                <div class="form-group">
                      <label class="col-sm-3 control-label">Posición imagen Hover</label>
                      <div class="col-sm-6">
                      <input name="posicion_over" id="posicion_over" type="text" class="form-control" placeholder="" value="<?php echo $datos->posicion_over;?>"></div>
                </div>   
                <div class="form-group">
