              ...
              <div class="table-responsive">
                ...
                <div class="pull-right">
                  ...
                  <div style="margin-top:20px; margin-right:20px;" id="datatable2_filter" class="dataTables_filter"> 
                    ...
                    <a class="btn btn-success" href="backend/Servicios/agregar"><i class="fa fa-plus-square"></i> Agregar</a>
                  </div>
                </div>
...
var tabla = '<?php echo $tabla;?>';
        $(document).ready(function (){
           jQuery("#list4").jqGrid({
             url:'<?php echo site_url("backend/ServerActions/executeIndex?q=8");?>',      //another controller 
            datatype: "json",
 ...
 function eliminar(idproducto){
  ...
  function buscar(){
    ...
    $("#list4").jqGrid('setGridParam',{url:"<?php echo site_url('backend/ServerActions/executeIndex?q=8&buscar_=true');?>&parametro1="+parametro1+"&parametro2="+parametro2+"&estado="+estado, datatype:"json", page:1}).trigger("reloadGrid");
    }   
</script>