      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header"><h3>Lista de Novedades</h3>
            </div>
            <div class="content">  
              <div class="table-responsive">
                ...
                <div class="pull-right">
                  ...
                  <div style="margin-top:20px; margin-right:20px;" id="datatable2_filter" class="dataTables_filter"> 
                    ...
                    <a class="btn btn-success" href="backend/Novedades/agregar"><i class="fa fa-plus-square"></i> Agregar</a>
                  </div>
                </div>
...
var tabla = '<?php echo $tabla;?>';
        $(document).ready(function (){                 
            jQuery("#list4").jqGrid({
            url: "<?php echo site_url('backend/ServerActions/executeIndex?q=8');?>",
            datatype: "json",
