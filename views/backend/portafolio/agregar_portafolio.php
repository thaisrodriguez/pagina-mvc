...
<?php $this->load->view('backend/layout/sidebar'); ?>
	<div class="container-fluid" id="pcont">    
      ...
      <ol class="breadcrumb">
          ...
          <li><a href="backend/Productos/index">Productos</a></li>
          <li><a href="backend/Productos/productos/<?php echo $datos_categoria->id;?>"><?php echo $datos_categoria->titulo;?></a></li>
          ...
          <div class="block-flat">
            ...
            <div class="content">
                ...
                <div class="form-group">
                      ...
                      <option <?php if($categoria->id == $datos_categoria->id): echo 'selected="selected"';endif;?> value="<?php echo $categoria->id;?>"><?php echo $categoria->titulo;?></option>
                      <?php endforeach;?>
                      </select>
                      </div>
                </div>
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-6"><input type="checkbox" name="p_nuevo" value="1" />
                      </div>
                </div>
                  </div><!-- Fin Tab -->
