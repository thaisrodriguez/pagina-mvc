      ...
      <div class="row">
        <div class="col-md-12">
          <div class="block-flat">
                <div style="margin-right:5px; margin-top:-14px;" class="pull-right">
                  <div class="dataTables_length" id="datatable-icons_length">
                    <label>Categoría :
                    <select aria-controls="datatable-icons" onchange="document.location.replace(this.value);" size="1" id="jeje" class="form-control" name="datatable-icons_length">
                    <?php foreach($lista_categoria as $categoria):?>
                       <option <?php if($categoria->id == $id_categoria): echo 'selected="selected"';endif;?> value="backend/Productos/productos/<?php echo $categoria->id;?>"><?php echo $categoria->titulo;?></option>
                    <?php endforeach;?>
                  </select></label></div>
                </div> 
            <div class="header"><h3>Categoría : <?php echo $datos_categoria->titulo;?></h3>
            </div>
            <div class="content">  
              <div class="table-responsive">
                ...
                <div class="pull-right">
                  ...
                  <div style="margin-top:20px; margin-right:20px;" id="datatable2_filter" class="dataTables_filter"> 
                    ...
                    <a class="btn btn-success" href="backend/Productos/agregar_portafolio/<?php echo $datos_categoria->id;?>"><i class="fa fa-plus-square"></i> Agregar</a>
                  </div>
                </div>
...
var tabla = '<?php echo $tabla;?>';
        $(document).ready(function (){                 
            jQuery("#list4").jqGrid({
            url: "<?php echo site_url('backend/ServerActions/executeIndex?q=3');?>&categoria=<?php echo $id_categoria;?>",
            datatype: "json",
            colNames:['Id','Nombre', 'Imagen', 'Fecha','Edición'],       //Grid column headings
                colModel:[
                    {name:'id',index:'id', width:10, align:"center"},
                    {name:'Nombre',index:'nombre', width:200, align:"left"},
                    {name:'Imagen',index:'nombre', width:50, align:"center"},
 ...
 function eliminar(idproducto){
  ...
  function buscar(){
    ...
    $("#list4").jqGrid('setGridParam',{url:"<?php echo site_url('backend/ServerActions/executeIndex?q=3&buscar_=true');?>&categoria=<?php echo $id_categoria;?>&parametro1="+parametro1+"&parametro2="+parametro2+"&estado="+estado, datatype:"json", page:1}).trigger("reloadGrid");
    }   
</script>