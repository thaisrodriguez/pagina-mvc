                ...
                <div style="margin-right:5px; margin-top:-14px;" class="pull-right">
                  <div class="dataTables_length" id="datatable-icons_length">
                    ...
                    <?php foreach($lista_categoria as $categoria):?>
                       <option <?php if($categoria->id == $id_categoria): echo 'selected="selected"';endif;?> value="backend/Tips/tips/<?php echo $categoria->id;?>"><?php echo $categoria->titulo;?></option>
                    <?php endforeach;?>
                  </select></label></div>
                </div> 
              ...
              <div class="table-responsive">
                ...
                <div class="pull-right">
                  ...
                  <div style="margin-top:20px; margin-right:20px;" id="datatable2_filter" class="dataTables_filter"> 
                    ...
                    <a class="btn btn-success" href="backend/Tips/agregar_tips/<?php echo $datos_categoria->id;?>"><i class="fa fa-plus-square"></i> Agregar</a>
                  </div>
                </div>
...
var tabla = '<?php echo $tabla;?>';
        $(document).ready(function (){                 
            jQuery("#list4").jqGrid({
            url: "<?php echo site_url('backend/ServerActions/executeIndex?q=5');?>&categoria=<?php echo $id_categoria;?>",
            datatype: "json",
 ...
 function eliminar(idproducto){
  ...
  function buscar(){
    ...
    $("#list4").jqGrid('setGridParam',{url:"<?php echo site_url('backend/ServerActions/executeIndex?q=5&buscar_=true');?>&categoria=<?php echo $id_categoria;?>&parametro1="+parametro1+"&parametro2="+parametro2+"&estado="+estado, datatype:"json", page:1}).trigger("reloadGrid");
    }   
</script>