...
<?php $this->load->view('backend/layout/sidebar'); ?>
	<div class="container-fluid" id="pcont">    
      ...
      <ol class="breadcrumb">
          ...
          <li><a href="backend/Tips/index">Tips</a></li>
          <li><a href="backend/Tips/portafolio/<?php echo $datos_categoria->id;?>"><?php echo $datos_categoria->titulo;?></a></li>
        ...
        <div class="col-md-12">          
          <div class="block-flat">
            ...
            <div class="content">
                ...
                <div class="form-group">
                            <label class="col-sm-3 control-label">Imagen: <br>666px x 407px</label>
                            <div class="col-sm-6">
