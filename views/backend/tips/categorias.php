...
var categoria = '<?php echo $categoria_;?>';
        $(document).ready(function (){                 
            jQuery("#list4").jqGrid({
            url: "<?php echo site_url('backend/ServerActions/executeIndex?q=4');?>",
            datatype: "json",
 ...
 function eliminar(idproducto){
  ...
  function buscar(){
    ...
    $("#list4").jqGrid('setGridParam',{url:"<?php echo site_url('backend/ServerActions/executeIndex?q=4&buscar_=true');?>&parametro1="+parametro1+"&parametro2="+parametro2+"&estado="+estado, datatype:"json", page:1}).trigger("reloadGrid");
    }   
</script>
