          ...
          <div class="block-flat">
            ...
            <div class="content">
              ...
              ?>
                ...
                <div class="form-group">
                      <label class="col-sm-3 control-label">Título en Web</label>
                      <div class="col-sm-6">
                      <input name="titulo_web" id="titulo_web" type="text" class="form-control" placeholder="" value="<?php echo $datos->titulo_web;?>"></div>
                </div>
                <div class="form-group">
                              <label class="col-sm-3 control-label">Descripción en Web</label>
                              <div class="col-sm-6">
                               <textarea name="descripcion_web" rows="3" class="form-control" id="descripcion_web" type="text"><?php echo $datos->descripcion_web;?></textarea>
                              </div>
                </div>
